...
export interface IGroup extends Document {
  ...
  settings: { welcome: boolean; welcomeText: string; welcomePhoto?: string; welcomeUrlButtons?: boolean; welcomeButtons?: Array<{ text: string; url: string }>; mediaBelowText?: boolean; rules?: string; verification: boolean; verificationTimeout: number; antiFlood: boolean; floodLimit: number; linkFilter: boolean; badWords: string[]; autoDeleteCommands: boolean; logChatId?: number; blueTheme: boolean; language: 'my' | 'en' | 'both'; [key: string]: unknown };
...
const GroupSchema = new Schema<IGroup>({
  ...
  settings: { welcome: { type: Boolean, default: true }, welcomeText: { type: String, default: 'မင်္ဂလာပါ {mention} 💙\nကျွန်တော်တို့ group မှ ကြိုဆိုပါတယ်။' }, welcomePhoto: String, welcomeUrlButtons: { type: Boolean, default: false }, welcomeButtons: { type: [{ text: String, url: String }], default: [] }, mediaBelowText: { type: Boolean, default: false }, regulation: { type: Boolean, default: false }, antispam: { type: Boolean, default: false }, antiflood: { type: Boolean, default: true }, goodbye: { type: Boolean, default: false }, alphabets: { type: Boolean, default: false }, captcha: { type: Boolean, default: false }, checks: { type: Boolean, default: false }, admin: { type: Boolean, default: false }, blocks: { type: Boolean, default: false }, media: { type: Boolean, default: false }, porn: { type: Boolean, default: false }, warns: { type: Boolean, default: true }, night: { type: Boolean, default: false }, tag: { type: Boolean, default: false }, link: { type: Boolean, default: false }, guardian: { type: Boolean, default: false }, approval: { type: Boolean, default: false }, delete: { type: Boolean, default: false }, other: { type: Boolean, default: false }, rules: String, verification: { type: Boolean, default: true }, verificationTimeout: { type: Number, default: 120 }, antiFlood: { type: Boolean, default: true }, floodLimit: { type: Number, default: 5 }, linkFilter: { type: Boolean, default: false }, badWords: { type: [String], default: [] }, autoDeleteCommands: { type: Boolean, default: false }, logChatId: Number, blueTheme: { type: Boolean, default: true }, language: { type: String, enum: ['my', 'en', 'both'], default: 'my' } },
